...
public class BaseApplication extends Application {
	...
	// 同一时间只有一个线程访问
	public synchronized OrderPreference getOrderPreference() {
		if (orderPreference == null)
			orderPreference = new OrderPreference(this);
	...
	// if (daoMaster == null) {
	// OpenHelper openHelper = new DaoMaster.DevOpenHelper(context, "quanzi.db",
	// null);
