 ...
 * 
 * @Title: ProblemPassword.java 
 * @Prject: ElephantBike
 * @Package: com.xxn.elephantbike.ui 
 * @Description: TODO
 * @author: Administrator   
 * @date: 2016年3月31日 上午9:24:23 
 * @version: V1.0   
 */
package com.xxn.elephantbike.ui;
...
/** 
 * @ClassName: ProblemPassword 
 * @Description: 不显示密码或密码错误问题界面
 * @author: 张勋
 * @date: 2016年3月31日 上午9:24:23  
 */
public class ProblemPasswordActivity extends BaseActivity implements OnClickListener, OnTouchListener{
	...
	private TextView nav_text,problem_type,problem_type_text,voice_desc,voice_desc_text
	,input_voice_tip,other_desc,other_desc_text;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_problem_password);
		...
		//		FontManager.changeFonts(root, ProblemPasswordActivity.this);
	}
	...
	public void onClick(View v) {
		...
		case R.id.submit:
			if (saveFilePath != null && saveFilePath.exists()) {
				final CustomPopDialog cp = new CustomPopDialog.Builder(ProblemPasswordActivity.this).create(9);
				cp.show();
	...
	private void upload_ques() {
		...
		LoadingPopTool.popLoadingStyle(ProblemPasswordActivity.this, true);
		...
		TextHttpResponseHandler responseHandler = new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
					String response) {
				LoadingPopTool.popLoadingStyle(ProblemPasswordActivity.this, false);
				...
				try {
					if (jsonTool.getStatus().equals("success")) {
						...
						intent.putExtra("fromActivityTo", "ProblemPasswordActivity"); // 这里用来传值
						AppManager.getInstance().killAllActivityNotCurr();
						intent.setClass(ProblemPasswordActivity.this, AccountSubmitActivity.class);
						ProblemPasswordActivity.this.startActivity(intent);
						ProblemPasswordActivity.this.finish();
					}else{
